...
class GetReviewsController extends Controller
{
    public function get(): JsonResponse|AnonymousResourceCollection
    {
        ...
        {
            return response()->json(['error' => 'Произошла ошибка при загрузке всех обзоров. Попробуйте перезагрузить страницу, если ошибка остаётся, то обратитесь в поддержку, Спасибо!',
                'status' => 400], 400);
        }
    }
}
