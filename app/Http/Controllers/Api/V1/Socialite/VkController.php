...
class VkController extends Controller
{
    ...
    /**
     * @OA\Get (tags={"Socialite"},
     *  path="/socialite/vk/connect",
     *  operationId="auth-socialite-vk-connect",
    ...
    /**
     * @OA\Get  (tags={"Socialite"},
     *  path="/socialite/vk/redirect",
     *  operationId="auth-socialite-vk-redirect",
     *  summary="validates an account",
     *      @OA\Response(
     *          response=200,
     *          description="Successful operation",
    ...
    /**
     * @OA\Post  (tags={"Socialite"},
     *  path="/socialite/vk/save-user",
     *  operationId="auth-socialite-vk-save-user",
     *  summary="validates an account",
     *      @OA\Response(
     *          response=200,
     *          description="Successful operation",
