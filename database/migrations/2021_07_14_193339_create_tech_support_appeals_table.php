...
class CreateTechSupportAppealsTable extends Migration
{
    public function up()
    {
        Schema::create('tech_support_appeals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tech_support_appeals');
    }
}
