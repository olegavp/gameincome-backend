...
class CreateSoftwarePurchasesTable extends Migration
{
    public function up()
    {
        Schema::create('software_purchases', function (Blueprint $table) {
            ...
            $table->foreign('key_id')->references('id')->on('software_keys');
            $table->uuid('item_id')->index('item_id');
            $table->foreign('item_id')->references('id')->on('software');
